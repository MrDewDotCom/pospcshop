...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  'customer.archive': 'ซ่อนลูกค้า',
  'customer.unarchive': 'แสดงลูกค้าอีกครั้ง',
  'sale.void': 'ยกเลิกบิลขาย',
  'return.create': 'รับคืนสินค้า',
  'return.refund_change': 'แก้ไขยอดคืนเงิน',
  'return.resolve': 'จัดการสินค้าคืน',
